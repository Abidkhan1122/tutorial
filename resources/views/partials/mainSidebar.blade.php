					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="{{ url('forms') }}" class="nav-link active">Forms</a></li>
								<li class="nav-item"><a href="{{ url('user-profile') }}" class="nav-link">userProfile</a></li>
								<li class="nav-item"><a href="{{ url('widgets') }}" class="nav-link">widgets</a></li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-color-sampler"></i> <span>My Crud</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								<li class="nav-item"><a href="../../../LTR/default/full/index.html" class="nav-link">Create</a></li>
								<li class="nav-item"><a href="index.html" class="nav-link active">Update</a></li>
								<li class="nav-item"><a href="index.html" class="nav-link active">Edit</a></li>
								<li class="nav-item"><a href="index.html" class="nav-link active">Delete</a></li>
